    ...
    "team_members": [
        {
            ...
            "student_id": "1367184",
            "email": "khanhnamn@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Cat Tuong Anh Nguyen",
            "student_id": "1380036",
            "email": "cattuonganh@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
